...
class Node(DpgNodeABC):
    ...
    node_label = "Gain Control(Scale Amplitude)"
    node_tag = "ScaleAmplitude"
    ...
    def update(
        ...
        scale = float(dpg_get_value(input_tag_list[1][1]))
        scale = float(np.clip(scale, 0, int(self._default_sampling_rate / 2)))
        dpg_set_value(input_tag_list[1][1], scale)
    ...
    def get_setting_dict(self, node_id):
        ...
        scale: float = float(dpg_get_value(input_tag_list[1][1]))
    ...
    def set_setting_dict(self, node_id, setting_dict):
        ...
        scale = float(setting_dict["scale"])
