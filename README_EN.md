...
* Use executable file (Windows only)
    1. Download [ipn-editor_win_x86_64.zip](https://github.com/Kazuhito00/Audio-Processing-Node-Editor/releases/download/v0.2.0/apn-editor_v0.2.0_win_x86_64.zip)
    1. Run "main.exe"
...
<table>
    <tr>
        ...
        <td width="760">
            A node that handles microphone input obtained via the web browser's getUserMedia().<br>
            When you create the node, the browser will launch. <br>
